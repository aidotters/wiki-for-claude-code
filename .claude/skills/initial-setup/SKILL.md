...
- docs/core/product-requirements.md（新規プロジェクトのみ）
...
- docs/core/decisions.md（設計判断記録 / ADR）
- docs/core/api-reference.md（オプション）
- docs/core/diagrams.md（オプション）
- docs/core/CHANGELOG.md（オプション）
```
